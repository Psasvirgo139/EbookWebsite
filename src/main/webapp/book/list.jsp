        ...
        <div class="books-container">
            ...
            <div class="search-filter-section">
                <div class="search-filter-row">
                    <form class="search-form" method="GET" action="${ctx}/home">
                        <input type="text" 
                               name="search" 
                               class="search-input" 
            ...
            <c:if test="${totalBooks > 0}">
                <div class="results-info">
                    ...
                    <c:if test="${not empty searchKeyword or not empty selectedGenre}">
                        <a href="${ctx}/home" class="clear-search">✕ Xóa bộ lọc</a>
                    </c:if>
                </div>
            </c:if>
            ...
            <div class="books-grid">
                <c:choose>
                    <c:when test="${empty ebookList and empty bookList}">
                        <div class="no-books">
                            ...
                            <c:if test="${not empty searchKeyword or not empty selectedGenre}">
                                <a href="${ctx}/home" class="btn-read">Xem tất cả truyện</a>
                            </c:if>
                    ...
                    <c:otherwise>
                        <!-- Support both ebookList and bookList for compatibility -->
                        <c:set var="books" value="${not empty ebookList ? ebookList : bookList}" />
                            ...
                            <div class="book-item">
                                ...
                                <div class="book-info">
                                    ...
                                    <div class="book-meta">
                                        ...
                                        <c:if test="${not empty book.releaseType}">
                                            <span class="book-genre">${book.releaseType}</span>
                                        </c:if>
                                    </div>
                                    
                                    <div class="book-actions">
                                        <a href="${ctx}/book/read?bookId=${book.id}&chapterId=1" class="btn-read">📖 Đọc ngay</a>
                                        <a href="${ctx}/book/detail?id=${book.id}" class="btn-view">👁️ Chi tiết</a>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>

    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .book-preview {
            ...
            padding: 1rem; background: var(--bg-tertiary); border-radius: 8px;
        }
        .book-cover-preview {
            width: 80px; height: 120px; border-radius: 8px; object-fit: cover;
        }
        .book-info h4 { margin: 0 0 0.5rem 0; }
        .book-info p { margin: 0; color: var(--text-secondary); }
    ...
    <main class="main">
        ...
        <div class="content">
            ...
            <div class="page-header">
                <h1 class="page-title">Edit Book: ${book.title}</h1>
            ...
            <div class="book-preview">
                <img src="${book.coverUrl}" alt="${book.title}" class="book-cover-preview"
                     onerror="this.src='https://via.placeholder.com/80x120?text=No+Cover'">
                <div class="book-info">
                    <h4>${book.title}</h4>
                    <p>ID: ${book.id} | Views: ${book.viewCount} | Created: ${book.createdAt}</p>
                    <p>Status: ${book.status} | Type: ${book.releaseType}</p>
                </div>
            </div>
                ...
                <div class="card-body">
                    <form action="update" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control form-textarea">${book.description}</textarea>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="releaseType" class="form-control">
                                    <option value="completed" ${book.releaseType == 'completed' ? 'selected' : ''}>Completed</option>
                                    <option value="ongoing" ${book.releaseType == 'ongoing' ? 'selected' : ''}>Ongoing</option>
                                    <option value="hiatus" ${book.releaseType == 'hiatus' ? 'selected' : ''}>Hiatus</option>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="visibility" class="form-control">
                                    <option value="public" ${book.visibility == 'public' ? 'selected' : ''}>Public</option>
                                    <option value="private" ${book.visibility == 'private' ? 'selected' : ''}>Private</option>
                                    <option value="premium" ${book.visibility == 'premium' ? 'selected' : ''}>Premium Only</option>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input type="checkbox" name="isPremium" id="isPremium" 
                                       ${book.isPremium ? 'checked' : ''}>
                                <label for="isPremium">Premium Book</label>
                            </div>
                        </div>

                        <div class="form-group" id="priceGroup" style="display: ${book.isPremium ? 'block' : 'none'};">

...
<html lang="en">
<head>
    <title>Register - EbookWebsite</title>
...
<div class="register-main">
    <div class="register-box">
        <div class="register-illustration">
            <img src="https://undraw.co/api/illustrations/undraw_book_lover_re_rwjy.svg" alt="Register Illustration"
            ...
            <div class="register-quote">“A book is a dream you hold in your hands.”</div>
        </div>
        <div class="register-form-section">
            <form class="register-form" action="${pageContext.request.contextPath}/register" method="post" autocomplete="off">
                <div class="register-logo">
                    <i class="fas fa-book-open"></i><span>EbookWebsite</span>
                </div>
                <div class="register-title">Create Account</div>
                <div class="register-subtitle">Join us and start your reading adventure!</div>
                <c:if test="${not empty error}">
                    <div class="register-alert"><i class="fas fa-exclamation-triangle"></i> ${error}</div>
                </c:if>
                <c:if test="${not empty success}">
                    <div class="register-success"><i class="fas fa-check-circle"></i> ${success}</div>
                </c:if>

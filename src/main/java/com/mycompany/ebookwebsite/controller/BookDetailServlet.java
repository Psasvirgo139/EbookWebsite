...
public class BookDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int id = EbookValidation.validateId(idParam); // Nếu có utils validate, dùng ở đây

            // Lấy EbookWithAI (kết hợp Ebooks + EbookAI)
            EbookWithAIService ebookWithAIService = new EbookWithAIService();
...
//    }
    ...
    private void showEditSummaryForm(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            EbookWithAIService ebookWithAIService = new EbookWithAIService();
            EbookWithAIService.EbookWithAI book = ebookWithAIService.getEbookWithAI(id);
            if (book == null) {
